...
local function step_1_instance(ctx)
    local vulkan = require("runtime.services.gpu.vulkan_core")
...
local function step_6_descriptors(ctx)
    local descriptors = require("runtime.services.gpu.descriptors")
    local memory = require("runtime.services.memory.memory")
...
local function step_7_compute(ctx)
    local compute = require("runtime.presentation.graphics.compute_pipeline")
