-- [File: runtime/services/memory/memory_alloc_gpu.lua]
...
local AllocGPU = {}
function AllocGPU.CreateHostVisibleBuffer(name, cdef_type, element_count, usage_flags, core_state)
...
function AllocGPU.CreateBufferHaven(name, byte_size, usage_flags, core_state)
    local vk = core_state.vk
...
function AllocGPU.DestroyBuffer(name, core_state)
    local vk = core_state.vk
