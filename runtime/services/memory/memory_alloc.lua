...
function Alloc.CreateHostVisibleBuffer(name, cdef_type, element_count, usage_flags, core_state)
...
function Alloc.AllocateSoA(type_str, count, names)
...
function Alloc.CreateBufferHaven(name, byte_size, usage_flags, core_state)
    local vk = core_state.vk
...
function Alloc.DestroyBuffer(name, core_state)
    local vk = core_state.vk
